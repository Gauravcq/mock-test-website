...
const QUESTIONS_DATABASE = {
    ...
    // IMPORTANT: The key here (e.g., "ssc_cgl_14_sep_s1")
    // must EXACTLY MATCH the 'id' from the tests-list.js file.
...
},
{
    ...
    "ssc_cgl_12_sep_s2": [
        {
            question: "Shift 2, Q1: What is 15% of 200?",
            options: ["15", "30", "20", "45"],
            correctAnswer: "30",
            explanation: "15% of 200 is (15/100) * 200 = 15 * 2 = 30."
        },
        {
            question: "Shift 2, Q2: What is the next prime number after 13?",
            options: ["14", "15", "17", "19"],
            correctAnswer: "17",
            explanation: "A prime number is a number greater than 1 that has no positive divisors other than 1 and itself. 17 is the next prime after 13."
        }
        // ... add questions for Shift 2 here ...
    ], // <-- Comma between tests
