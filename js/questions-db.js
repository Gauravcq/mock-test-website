...
const QUESTIONS_DATABASE = {
    ...
    "ssc_cgl_12_sep_s2": [
        ...
        },
        {
            ...
            "correct answer": "139 m\u00b2",
            "explanation": "Inner radius $r=14$ m. Outer radius $R = 14 + 1.5 = 15.5$ m. Area of Path = $\pi (R^2 - r^2) = \pi (15.5^2 - 14^2) = \pi (240.25 - 196) = 44.25\pi$. Using $\pi \approx 22/7$, Area $\approx 139.097 \text{ m}^2$, which is $139 \text{ m}^2$ (approx)."
        },
        {
